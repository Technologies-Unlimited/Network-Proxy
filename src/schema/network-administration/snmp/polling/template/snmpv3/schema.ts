/**
 * SNMPv3 Polling Template Schema
 * Defines the structure for SNMPv3 polling template data with SQLite
 */
...
/**
 * Extended interface for SNMPv3 polling template that includes all fields needed for storage
 */
export interface ExtendedSNMPv3PollingTemplateFields
  ...
  companyId: string
  createdAt: number
  // SNMPv3 specific fields could be added here
}

/**
 * SQLite table schema for SNMPv3 polling templates
 * This is implemented in the database/index.ts file
 */
export const snmpv3PollingTemplateTableSchema = `
  CREATE TABLE IF NOT EXISTS snmpv3_polling_templates (
