            ...
            try {
                ...
                if (discoverBtn) {
                    ...
                    function enhancedClickHandler(event) {
                        ...
                        debugLog('Button state: ' + (discoverBtn.disabled ? 'disabled' : 'enabled'), 'info');
                        ...
                        if (serversStatus) {
                            ...
                            serversStatus.textContent = 'Discovering iperf servers... (enhanced click handler)';
                        ...
                        setTimeout(function() {
                            if (discoverBtn.disabled) {
                                debugLog('Force re-enabling discover button after timeout', 'warn');
                    ...
                    debugLog('discoverServersBtn not found! Cannot enhance click handler', 'error');
                }
            } catch (error) {
                debugLog('Error setting up enhanced click handler: ' + error.message, 'error');
            }
        }, 1000);
    });
})();