  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <Box sx={{ maxWidth: 1200, margin: '0 auto', padding: 2 }}>
        <Button startIcon={<ArrowBackIcon />} href="/" sx={{ marginBottom: 2 }}>
          Back to Home
        </Button>
        ...
        <Paper sx={{ marginTop: 2 }}>
          ...
          <TabPanel value={tabValue} index={0}>
            ...
            <Typography paragraph>
              ICMP (Internet Control Message Protocol) monitoring tools and
              configuration.
            </Typography>
          </TabPanel>
          ...
          <TabPanel value={tabValue} index={1}>
            ...
            <Typography paragraph>
              SNMP (Simple Network Management Protocol) device management and
              monitoring.
            </Typography>
          </TabPanel>
