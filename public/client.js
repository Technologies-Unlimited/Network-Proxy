    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: '𓇋',
          description:
            'Trace network paths with max hops, IP address, and hostname',
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: '𓊖',
          description:
            'Configure SNMP polling frequency, timeouts, and retries',
        },
      ],
    },
    {
              ...
              h(
                'span',
                {
                  style: {
                    ...
                    transform:
                      hoveredTile === section.id ? 'scale(1.1)' : 'scale(1)',
                  },
                },
                section.icon
              ),
              ...
              style: {
                background:
                  navigationSections.find(s => s.id === activeSection)
                    ?.gradient ||
                  navigationSections.find(s => s.id === activeSection)?.color ||
                  '#d4af37',
                padding: '20px 25px',
                display: 'flex',
                alignItems: 'center',
